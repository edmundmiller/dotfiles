...
# - Loads generated global and Pi-specific skills from skills/catalog/
...
let
  ...
  # (skills/flake.nix). Pi reads ~/.agents/skills and ~/.pi/agent/skills
  # natively; target-specific skills go in the latter.
