...
in
{
  options.modules.shell.zsh = with types; {
    ...
    rcFiles = mkOpt (listOf (either str path)) [ "${configDir}/zsh/prompt.zsh" ];
  ...
  config = mkIf cfg.enable (mkMerge [
    {
      ...
      home.configFile = {
        ...
        # Create extra.zshrc with rcInit content and completion generation
        "zsh/extra.zshrc".text = ''
          # This file was autogenerated, do not edit it!
          # Auto-generate hey completion from just at shell startup
          if [[ ! -f $ZDOTDIR/completions/_hey ]] || [[ ${pkgs.just}/bin/just -nt $ZDOTDIR/completions/_hey ]]; then
            mkdir -p $ZDOTDIR/completions
            ${pkgs.just}/bin/just --completions zsh > $ZDOTDIR/completions/_hey 2>/dev/null || true
          fi
