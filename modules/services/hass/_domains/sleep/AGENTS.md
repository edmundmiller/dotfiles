...
- Circadian driver: Edmund's next Eight Sleep alarm when Edmund is home; iOS next-alarm sync is declaratively disabled until we add an HA helper or Shortcut bridge
