...
- Follow the root and nearest nested runtime instruction file (`AGENTS.md` or
  `CLAUDE.md`). Load a matching skill or canonical document when the task needs
  a procedure; do not improvise around an existing guarded interface.
