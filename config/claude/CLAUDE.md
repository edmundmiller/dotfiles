...
- **Automatically use context7 for code generation and library documentation.** When working with code examples, setup steps, configuration, or library/API documentation, proactively use context7 tools to provide accurate, up-to-date information.
