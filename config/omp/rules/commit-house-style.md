...
stable: true
condition: "\\b(?:git\\s+commit|jj\\s+(?:commit|describe))\\b"
scope: "tool:bash"
---

## Commit house style

Before committing, review and rewrite the message using this house style:
...
- Add a body only for why, tradeoffs, surprising constraints, exact evidence, or attribution. Preserve real co-authors.
