---
description: Migrate Snakemake pipeline to Nextflow
model: opencode/claude-sonnet-4-5
---

Snakemake files in project:
!`find . -name "Snakefile*" -o -name "*.smk" 2>/dev/null | head -20 || echo "No Snakemake files found in current directory"`
