...
- Current pins are `tnote` `f968abc` and `agents-workspace` `289b1c0`; both predate the profiled fixes and reproduce the expensive paths. Pin pushed upstream `main` commits `984117b8167e4a9c89b3a4d15add212ef263b532` and `d5c92cac98ea0ac25613429e6bfc00f97a70b9c3` through `flake.nix`/`flake.lock`.
...
- Upstream verification: `git ls-remote` reports target commits as both repositories' `refs/heads/main`.
