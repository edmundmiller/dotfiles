...
- [agents/unslop.md](./agents/unslop.md) — unslop pin, writing route, and
  adjacent slop-tool boundaries
- [agents/oxlint.md](./agents/oxlint.md) — default anti-slop Oxlint and
  opt-in TypeSafe Jev rules
