...
- **OpenWiki CLI**: `pkgs.my.openwiki` installed system-wide; activation removes stale npm shims so the patched Nix build owns personal-wiki ingestion and scheduling
