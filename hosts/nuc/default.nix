...
in
{
  ...
  systemd.services.buzz-mill-docs-flue = {
    ...
    after = [ "network-online.target" "mill-docs-git-pull.service" ];
    wants = [ "network-online.target" "mill-docs-git-pull.service" ];
    ...
    serviceConfig = {
      ...
      ProtectSystem = "strict";
      ProtectHome = "tmpfs";
      BindPaths = [ millDocsVaultPath buzzMillDocsFlueStateDir ];
      InaccessiblePaths = [
        "-/run/docker.sock"
        "-/run/podman/podman.sock"
      ];
